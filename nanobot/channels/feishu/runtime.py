...
# Message-content parsers live in feishu/parsers.py; re-export so existing
# import sites keep working unchanged.
from nanobot.channels.feishu.parsers import (  # noqa: E402
    MSG_TYPE_MAP,
    _extract_element_content,  # noqa: F401 (re-export for tests)
