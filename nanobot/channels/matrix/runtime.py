...
_MXC_PLACEHOLDER_SRC_RE = re.compile(rf'src="{re.escape(_MXC_IMAGE_PLACEHOLDER_PREFIX)}([^"]+)"')
...
def _mask_mxc_markdown_image_sources(text: str) -> str:
    def repl(match: re.Match[str]) -> str:
        ...
        return (
            f"{match.group('prefix')}{_MXC_IMAGE_PLACEHOLDER_PREFIX}{value}{match.group('suffix')}"
        )
