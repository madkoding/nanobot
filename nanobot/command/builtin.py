...
# Dream command handlers live in builtin_dream.py; re-export so existing
# import sites (and the palette below) keep working unchanged.
from nanobot.command.builtin_dream import (  # noqa: E402
    cmd_dream,
    cmd_dream_log,
    cmd_dream_prompt,
    cmd_dream_restore,
